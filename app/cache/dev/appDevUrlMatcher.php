    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                ...
                goto not_hff_blog_homepage;
            }

            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'hff_blog_homepage');
            }

            return array (  '_controller' => 'Hff\\BlogBundle\\Controller\\PaginasController::indexAction',  '_route' => 'hff_blog_homepage',);
        }
