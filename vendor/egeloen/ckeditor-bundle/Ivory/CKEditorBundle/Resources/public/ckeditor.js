 ...
 */
        (function() {
            ...
            window.CKEDITOR || (window.CKEDITOR = function() {
                var b = {timestamp: "D5AC", version: "4.1.2", revision: "d6f1e0e", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function() {
            ...
            CKEDITOR.event || (CKEDITOR.event = function() {
                ...
                return{define: function(a, f) {
                        ...
                        function j(b, g, n, p) {
                            b = {name: a, sender: this, editor: b, data: g, listenerData: c, stop: n, cancel: p, removeListener: m};
            ...
            CKEDITOR.env || (CKEDITOR.env = function() {
                ...
                if (a.webkit)
                    b.indexOf("chrome") > -1 ? a.chrome = true : a.safari = true;
                var e = 0;
                if (a.ie) {
                ...
                if (a.gecko)
                    if (e <
                        ...
                        a.cssClass = a.cssClass + " cke_browser_gecko19";
                if (a.air)
                    a.cssClass = a.cssClass + " cke_browser_air";
                if (a.iOS)
                    a.cssClass = a.cssClass + " cke_browser_ios";
                return a
            }());
            ...
            (function() {
                ...
                CKEDITOR.tools = {arrayCompare: function(a, e) {
                        ...
                        if (a === null || typeof a != "object" ||
                                a instanceof String || a instanceof Number || a instanceof Boolean || a instanceof Date || a instanceof RegExp)
                            return a;
                        e = new a.constructor;
                        for (b in a)
                            e[b] = CKEDITOR.tools.clone(a[b]);
                        ...
                        if (typeof(f = arguments[b - 1]) == "boolean")
                            b--;
                        ...
                        var b = a.$,
                                f = a.base, d = a.privates || a._, c = a.proto, a = a.statics;
                        !b && (b = function() {
            ...
            CKEDITOR.dtd = function() {
                var b = CKEDITOR.tools.extend, c = function(a, b) {
                    ...
                    return e
                }, a = {}, e = {}, f = {address: 1, article: 1, aside: 1, blockquote: 1, details: 1, div: 1, dl: 1, fieldset: 1, figure: 1, footer: 1, form: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, header: 1, hgroup: 1, hr: 1, menu: 1, nav: 1, ol: 1, p: 1, pre: 1, section: 1, table: 1, ul: 1}, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, i = {}, l = {"#": 1}, j = {center: 1, dir: 1, noframes: 1};
                ...
                b(e, f, a, j);
                c = {a: c(a, {a: 1, button: 1}), abbr: a, address: e,
                    ...
                    sub: a, summary: a, sup: a, table: {caption: 1, colgroup: 1, thead: 1, tfoot: 1, tbody: 1, tr: 1}, tbody: {tr: 1}, td: e, textarea: l, tfoot: {tr: 1}, th: e, thead: {tr: 1}, time: c(a, {time: 1}), title: l, tr: {th: 1, td: 1}, track: i, u: a, ul: {li: 1}, "var": a, video: b({source: 1, track: 1}, e), wbr: i, acronym: a, applet: b({param: 1}, e), basefont: i, big: a, center: e, dialog: i, dir: {li: 1}, font: a, isindex: i, noframes: e, strike: a, tt: a};
                b(c, {$block: b({audio: 1, dd: 1, dt: 1, li: 1, video: 1}, f, j), $blockLimit: {article: 1, aside: 1, audio: 1, body: 1, caption: 1, details: 1, dir: 1, div: 1, dl: 1,
            ...
            CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {appendTo: function(b, c) {
                    ...
                    if (a && !a.call)
                        var e = a, a = function(a) {
                        return!a.equals(e)
                    };
                    var b = !b && this.getFirst && this.getFirst(), f;
                    if (!b) {
                        if (this.type == CKEDITOR.NODE_ELEMENT && a && a(this, true) === false)
                            return null;
                        b = this.getNext()
                    }
                    ...
                    var c =
                            this.$, a;
                    do
                        a = (c = c.previousSibling) && c.nodeType != 10 && new CKEDITOR.dom.node(c);
                    while (a && b && !b(a));
                    return a
                }, getNext: function(b) {
                    var c = this.$, a;
                    do
                        a = (c = c.nextSibling) && new CKEDITOR.dom.node(c);
                    while (a && b && !b(a));
                    return a
                    ...
                    if (c.compareDocumentPosition)
                        return c.compareDocumentPosition(a);
                    if (c == a)
                    ...
                    if (this.type == CKEDITOR.NODE_ELEMENT && b.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if ("sourceIndex"in c)
                            return c.sourceIndex < 0 || a.sourceIndex < 0 ? CKEDITOR.POSITION_DISCONNECTED : c.sourceIndex < a.sourceIndex ? CKEDITOR.POSITION_PRECEDING : CKEDITOR.POSITION_FOLLOWING
                    }
                    for (var c = this.getAddress(), b = b.getAddress(), a = Math.min(c.length, b.length), e = 0; e <= a - 1; e++)
                        if (c[e] != b[e]) {
                            if (e < a)
                                return c[e] < b[e] ? CKEDITOR.POSITION_PRECEDING : CKEDITOR.POSITION_FOLLOWING;
                            break
                        }
                    ...
                    if (!c)
                        a = a.parentNode;
                    for (; a; ) {
                        if (a.nodeName && a.nodeName.toLowerCase() == b)
                            return true;
                        a = a.parentNode
                    }
                    return false
                    ...
                    if (a) {
                        if (b)
                            for (; b = c.firstChild; )
                                a.insertBefore(c.removeChild(b), c);
                        a.removeChild(c)
                    }
                    return this
                }, replace: function(b) {
                    ...
                    if (!CKEDITOR.env.ie && !CKEDITOR.env.opera)
                        (b = this.$.lastChild) && (b.type == 1 && b.nodeName.toLowerCase() == "br") && b.parentNode.removeChild(b)
                }, isReadOnly: function() {
                    var b = this;
            ...
            CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function(b) {
                    ...
                    if ((!CKEDITOR.env.ie || document.documentMode > 8) && c)
                        b = c + ":" + b;
            ...
            CKEDITOR.dom.element.setMarker = function(b, c, a, e) {
                var f = c.getCustomData("list_marker_id") || c.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"), d = c.getCustomData("list_marker_names") || c.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
                b[f] = c;
                d[a] = 1;
            ...
            CKEDITOR.dom.element.clearAllMarkers = function(b) {
                for (var c in b)
                    CKEDITOR.dom.element.clearMarkers(b, b[c], 1)
            };
            ...
            (function() {
                ...
                CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function(a) {
                        ...
                        if (b) {
                            a = RegExp("(?:^|\\s+)" + a + "(?=\\s|$)", "i");
                            if (a.test(b))
                                (b = b.replace(a, "").replace(/^\s+/, "")) ? this.setAttribute("class",
                        ...
                        for (var a = this.getLast(); a && a.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.rtrim(a.getText()); )
                            a = a.getPrevious();
                        if (!a || !a.is || !a.is("br")) {
                    ...
                    getTabIndex: CKEDITOR.env.ie ? function() {
                        ...
                        if (this.isReadOnly() || this.getComputedStyle("display") == "none" || this.getComputedStyle("visibility") == "hidden" || CKEDITOR.dtd.$nonEditable[b] || CKEDITOR.dtd.$empty[b] || this.is("a") &&
                                (this.data("cke-saved-name") || this.hasAttribute("name")) && !this.getChildCount())
                            return false;
                        if (a !== false) {
                    ...
                    hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function() {
                        ...
                        if (c != a) {
                            ...
                            if (b)
                                for (; d = c.lastChild; )
                                    a.insertBefore(c.removeChild(d), a.firstChild);
                            else
                                for (; d = c.firstChild; )
                                    a.appendChild(c.removeChild(d))
                        }
                        ...
                        function a(a, b, c) {
                            if (b && b.type == CKEDITOR.NODE_ELEMENT) {
                                ...
                                if (a.isIdentical(b)) {
                                    for (var l = c ? a.getLast() : a.getFirst(); i.length; )
                                        i.shift().move(a, !c);
                                    b.moveChildren(a, !c);
                                    b.remove();
                        ...
                        if (document.documentElement.getBoundingClientRect) {
                            var j =
                                    this.$.getBoundingClientRect(), m = d.$.documentElement, n = m.clientTop || i.$.clientTop || 0, q = m.clientLeft || i.$.clientLeft || 0, p = true;
                            if (CKEDITOR.env.ie) {
                        ...
                        if (j < 0 || i > 0)
                            m(0, b === true ? j : b === false ? i : j < 0 ? j : i);
                        if (c && (l < 0 || d > 0))
                            m(l < 0 ? l : d, 0)
                    ...
                    copyAttributes: function(a, b) {
                        for (var c = this.$.attributes, b = b || {}, d = 0; d < c.length; d++) {
                            ...
                            if (!(l in b))
                                if (l == "checked" && (j = this.getAttribute(l)))
                                    a.setAttribute(l, j);
                ...
                CKEDITOR.dom.element.prototype.setSize = function(a, c, f) {
                    if (typeof c == "number") {
                        if (f && (!CKEDITOR.env.ie || !CKEDITOR.env.quirks))
                            c = c - b.call(this, a);
            ...
            (function() {
                function b(a, b) {
                    ...
                    d = c.endContainer;
                    var q = c.startOffset, p = c.endOffset, h, g = this.guard, u = this.type, e = a ? "getPreviousSourceNode" : "getNextSourceNode";
                    if (!a && !this._.guardLTR) {
                        var k = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), f = d.type == CKEDITOR.NODE_ELEMENT ? d.getChild(p) : d.getNext();
                    ...
                    if (a && !this._.guardRTL) {
                        var B = n.type == CKEDITOR.NODE_ELEMENT ? n : n.getParent(), z = n.type == CKEDITOR.NODE_ELEMENT ? q ? n.getChild(q - 1) : null : n.getPrevious();
                ...
                function c(a) {
                    for (var c, d = null; c = b.call(this, a); )
                        d = c;
                    return d
                }
                ...
                var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, f = CKEDITOR.dom.walker.whitespaces(), d = CKEDITOR.dom.walker.bookmark();
            ...
            (function() {
                function b() {
                    var a = false, b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.dom.walker.bookmark(true), h = CKEDITOR.dom.walker.bogus();
                    return function(g) {
                        if (c(g) || b(g))
                            return true;
                        if (h(g) && !a)
                ...
                var e = function(a) {
                    ...
                    for (var m = c, r, A, v, o = l; o < e.length; o++) {
                        ...
                        for (r = r.getNext(); r; ) {
                            if (r.equals(k[o]) || r.equals(d))
                                break;
                            v = r.getNext();
                            if (b == 2)
                                m.append(r.clone(true));
                            else {
                                r.remove();
                                b == 1 && m.append(r)
                            }
                    ...
                    for (c = l; c < k.length; c++) {
                        ...
                        if (!e[c] || r.$.parentNode != e[c].$.parentNode)
                            for (r = r.getPrevious(); r; ) {
                                if (r.equals(e[c]) || r.equals(g))
                                    break;
                                v = r.getPrevious();
                                if (b == 2)
                                    m.$.insertBefore(r.$.cloneNode(true), m.$.firstChild);
                                else {
                                    r.remove();
                    ...
                    if (b == 2) {
                        ...
                        if (j && s && (g.$.parentNode != j.$.parentNode || d.$.parentNode != s.$.parentNode)) {
                            ...
                            if (h && j.type == CKEDITOR.NODE_ELEMENT) {
                                ...
                                a.setStart(s.getParent(), b)
                        }
                        a.collapse(true)
                    }
                    i && g.remove();
                    f && d.$.parentNode && d.remove()
                }, d = {abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1}, i = CKEDITOR.dom.walker.bogus(), l = new CKEDITOR.dom.walker.whitespaces, j = new CKEDITOR.dom.walker.bookmark, m = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
                CKEDITOR.dom.range.prototype = {clone: function() {
                        ...
                        return{startNode: a ? h + (d ? "C" : "S") : b, endNode: a ? h + "E" : c, serializable: a, collapsed: d}
                    }, createBookmark2: function(a) {
                        var b = this.startContainer, c = this.endContainer, h = this.startOffset, g = this.endOffset, d = this.collapsed, e, k;
                        if (!b || !c)
                        ...
                        return{start: b.getAddress(a),
                            end: d ? null : c.getAddress(a), startOffset: h, endOffset: g, normalized: a, collapsed: d, is2: true}
                    }, moveToBookmark: function(a) {
                        if (a.is2) {
                            var b = this.document.getByAddress(a.start, a.normalized), c = a.startOffset, h = a.end && this.document.getByAddress(a.end, a.normalized), a = a.endOffset;
                            this.setStart(b, c);
                        ...
                        if (b.type == CKEDITOR.NODE_ELEMENT) {
                            g = b.getChildCount();
                            if (g > h)
                                b = b.getChild(h).getPreviousSourceNode(true);
                            else if (g < 1)
                        ...
                        var c = this.startContainer, h = this.endContainer, c = c.equals(h) ? a && c.type == CKEDITOR.NODE_ELEMENT && this.startOffset == this.endOffset - 1 ? c.getChild(this.startOffset) : c : c.getCommonAncestor(h);
                        ...
                        var c = this.startContainer,
                                h = this.startOffset, g = this.collapsed;
                        ...
                        switch (a) {
                            ...
                            case CKEDITOR.ENLARGE_ELEMENT:
                                ...
                                for (; k || i; ) {
                                    if (k && !i) {
                                        !f && k.equals(h) && (f = true);
                                        if (c ? k.isBlockBoundary() : !g.contains(k))
                                            break;
                                    ...
                                    for (; i; ) {
                                        j = false;
                                        if (i.type == CKEDITOR.NODE_COMMENT)
                                            i = i.getPrevious();
                                        else {
                            ...
                            case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                                ...
                                if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                                    ...
                                    if ((k = k.previous()) && k.type == CKEDITOR.NODE_ELEMENT && k.is("br"))
                                        break
                                }
                                k = this.clone();
                                k.collapse();
                        ...
                        if (!this.collapsed) {
                            var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), g = this.startContainer, e = this.endContainer, i = this.startOffset, k = this.endOffset, f = 1, j = 1;
                            ...
                            d.guard = function(b, d) {
                                if (l(b))
                                    return true;
                                if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(m) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary())
                                    return false;
                                !d && b.type == CKEDITOR.NODE_ELEMENT && (m = b);
                                return true
                            };
                            if (f)
                                (g = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" :
                    ...
                    moveToPosition: function(a, b) {
                        ...
                        var b =
                                new CKEDITOR.dom.elementPath(this.startContainer, this.root), c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), d = b.block, g = c.block, e = null;
                        ...
                        for (var d = 0; b; ) {
                            ...
                            if (b.type == CKEDITOR.NODE_ELEMENT)
                                if (b.isEditable()) {
                                    ...
                                    c && (b.is("br") && this.checkEndOfBlock()) && this.moveToPosition(b, CKEDITOR.POSITION_BEFORE_START);
            ...
            (function() {
                ...
                function c(a, b, c) {
                    for (a = a.getNextSourceNode(b, null, c); !e(a); )
                        a = a.getNextSourceNode(b, null, c);
                    return a
                }
                var a = /^[\r\n\t ]+$/, e = CKEDITOR.dom.walker.bookmark(false, true), f = CKEDITOR.dom.walker.whitespaces(true), d = function(a) {
                    return e(a) && f(a)
                };
                b.prototype = {getNextParagraph: function(b) {
                        b = b || "p";
                        if (!CKEDITOR.dtd[this.range.root.getName()][b])
                            return null;
                        var f,
                                j, m, n, q, p;
                        if (!this._.started) {
                        ...
                        for (this._.nextNode = null; h; ) {
                            ...
                            if (w)
                                h.type == CKEDITOR.NODE_TEXT && a.test(h.getText()) && (w = 0);
                            else {
                                var t = h.getName();
                        ...
                        if (!f) {
                            ...
                            g = {div: 1, th: 1, td: 1};
                            f = f.block;
                            if (!f && h && !this.enforceRealBlocks && g[h.getName()] && j.checkStartOfBlock() && j.checkEndOfBlock() && !h.equals(j.root))
                                f = h;
                                ...
                                this._.nextNode = f.equals(n) ? null : c(j.getBoundaryNodes().endNode, 1, n)
                        }
                        if (q)
                            (j = f.getPrevious()) && j.type == CKEDITOR.NODE_ELEMENT && (j.getName() == "br" ? j.remove() : j.getLast() && j.getLast().$.nodeName.toLowerCase() == "br" && j.getLast().remove());
                        if (p)
                            (j = f.getLast()) && j.type == CKEDITOR.NODE_ELEMENT && j.getName() == "br" && (CKEDITOR.env.ie || j.getPrevious(e) || j.getNext(e)) && j.remove();
                        if (!this._.nextNode)
                            this._.nextNode = m ||
            ...
            CKEDITOR.command.prototype = {enable: function() {
                    ...
                    if (this.state == b || !this.checkAllowed())
                        return false;
            ...
            (function() {
                    ...
                    if ((g || typeof a.elements != "function" || a.elements(e)) && (!a.match || a.match(b))) {
                        ...
                        if (!g) {
                            if (!a.propertiesOnly)
                                d.valid = true;
                            if (!d.allAttributes)
                                d.allAttributes = c(a.attributes, b.attributes, d.validAttributes);
                            if (!d.allStyles)
                                d.allStyles =
                ...
                function e(a) {
                    ...
                    return a._.filterFunction = function(g, h, e, k, i, f, p) {
                        ...
                        if (h) {
                            ...
                            if (e) {
                                o = 0;
                                for (q = e.length; o < q; ++o)
                                    b(e[o], g, h, true, f)
                            }
                            if (w) {
                                o = 0;
                                for (q = w.length; o < q; ++o)
                                    b(w[o], g, h, false, f)
                            }
                            if (!h.valid) {
                                k.push(g);
                                ...
                                for (var e = g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g.name == "body", f, k = d.length; k > 0; ) {
                                    ...
                                    if (e && (i.type == CKEDITOR.NODE_TEXT || i.type == CKEDITOR.NODE_ELEMENT && z.$inline[i.name])) {
                                        ...
                                        g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (i.type ==
                                                CKEDITOR.NODE_ELEMENT && !z[g.name][i.name]) && c.push({check: "el-up", el: i})
                                    }
                                }
                                a.remove()
                            }
                ...
                CKEDITOR.filter.prototype = {allow: function(b, c, d) {
                        if (this.disabled || this.customConfig && !d || !b)
                            return false;
                        this._.cachedChecks = {};
                        var g, h;
                        if (typeof b == "string")
                        ...
                        var d = [], h = !c && this._.rules, k = this._.transformations, f = e(this), i = this.editor && this.editor.config.protectedSource, u = false;
                        ...
                        if (typeof a == "string") {
                            ...
                            if (k in this._.cachedChecks)
                                return this._.cachedChecks[k];
                            g = i(a).$1;
                            h = g.styles;
                            var f = g.classes;
                            g.name = g.elements;
                            ...
                            if (h) {
                                ...
                                h = {};
                            h = {name: g.element, attributes: f, classes: f["class"] ? f["class"].split(/\s+/) : [], styles: h, children: []}
                        }
                ...
                var r = {styles: 1, attributes: 1, classes: 1}, A = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"}, v = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, o = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/,
                    classes: /\(([^\)]+)\)/}, x = CKEDITOR.filter.transformationsTools = {sizeToStyle: function(a) {
                        ...
                        if (typeof b == "string")
                            ...
                            var c = b.getDefinition(), d = c.styles, g = c.attributes,
                                    h, e, k, f;
                            a.name = c.element;
                            for (h in g)
                                if (h == "class") {
                                    c = a.classes.join("|");
                                    for (k = g[h].split(/\s+/); f = k.pop(); )
                                        c.indexOf(f) == -1 && a.classes.push(f)
                                } else
                                    a.attributes[h] = g[h];
                            for (e in d)
                                a.styles[e] = d[e]
            ...
            (function() {
                ...
                CKEDITOR.keystrokeHandler.prototype = {attach: function(b) {
                        ...
                        if (CKEDITOR.env.opera || CKEDITOR.env.gecko && CKEDITOR.env.mac)
                            b.on("keypress", a, this)
                    }}
            })();
            (function() {
                CKEDITOR.lang = {languages: {af: 1, ar: 1, bg: 1, bn: 1, bs: 1, ca: 1, cs: 1, cy: 1, da: 1, de: 1, el: 1, "en-au": 1, "en-ca": 1, "en-gb": 1, en: 1, eo: 1, es: 1, et: 1, eu: 1, fa: 1, fi: 1, fo: 1, "fr-ca": 1, fr: 1, gl: 1, gu: 1, he: 1, hi: 1, hr: 1, hu: 1, is: 1, it: 1, ja: 1, ka: 1, km: 1, ko: 1, ku: 1, lt: 1, lv: 1, mk: 1, mn: 1, ms: 1, nb: 1, nl: 1, no: 1, pl: 1, "pt-br": 1, pt: 1, ro: 1, ru: 1, si: 1, sk: 1, sl: 1, sq: 1, "sr-latn": 1, sr: 1, sv: 1, th: 1, tr: 1, ug: 1, uk: 1, vi: 1, "zh-cn": 1, zh: 1}, load: function(b, c, a) {
                        ...
                        var a = this.languages, c = c || navigator.userLanguage || navigator.language || b, e = c.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), f = e[1], e = e[2];
            ...
            CKEDITOR.scriptLoader = function() {
                var b = {}, c = {};
                return{load: function(a, e, f, d) {
                        var i = typeof a == "string";
                        i && (a = [a]);
                        f || (f = CKEDITOR);
                        var l = a.length, j = [], m = [], n = function(a) {
            ...
            CKEDITOR.resourceManager.prototype = {add: function(b, c) {
                    ...
                    for (var b = b.split(","), e = 0; e < b.length; e++)
                        this.externals[b[e]] = {dir: c, file: a}
                }, load: function(b, c, a) {
                    ...
                    CKEDITOR.scriptLoader.load(d, function(b,
                            d) {
                        if (d.length)
                            throw'[CKEDITOR.resourceManager.load] Resource name "' + i[d[0]].join(",") + '" was not found at "' + d[0] + '".';
            ...
            CKEDITOR.ui.prototype = {add: function(b, c, a) {
                    ...
                    var e = this.items[b] = {type: c, command: a.command || null, args: Array.prototype.slice.call(arguments, 2)};
                    CKEDITOR.tools.extend(e, a)
                }, get: function(b) {
                    return this.instances[b]
                }, create: function(b) {
                    var c = this.items[b], a = c && this._.handlers[c.type], e = c && c.command && this.editor.getCommand(c.command), a = a && a.create.apply(this, c.args);
                    this.instances[b] = a;
                    e && e.uiItems.push(a);
                    if (a && !a.type)
                        a.type = c.type;
            ...
            (function() {
                ...
                function n(a) {
                    ...
                    if (h)
                        var f = RegExp("(?:^|,)(?:" + h.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(f, "");
                    ...
                    CKEDITOR.plugins.load(c.split(","), function(c) {
                        ...
                        for (var k in c) {
                            ...
                            if (o && !a.lang[k]) {
                                o.split && (o = o.split(","));
                                if (CKEDITOR.tools.indexOf(o, a.langCode) >= 0)
                                    p = a.langCode;
                                else {
                ...
                CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {addCommand: function(a, b) {
                        ...
                        if (c && c.state != CKEDITOR.TRISTATE_DISABLED &&
                            ...
                            if (!c.async && this.fire("afterCommandExec", d) !== true)
                    ...
                    setKeystroke: function() {
                        for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, d, h = b.length; h--; ) {
                            c = b[h];
                            d = 0;
            ...
            (function() {
                ...
                CKEDITOR.htmlParser.node.prototype = {remove: function() {
                        ...
                        var c = this.parent.children, a = CKEDITOR.tools.indexOf(c, this), e = b.previous = this.previous, f = b.next = this.next;
                        e && (e.next = b);
                        f && (f.previous = b);
                        c[a] = b;
                        ...
                        var c = b.parent.children,
                                a = CKEDITOR.tools.indexOf(c, b), e = b.next;
                        c.splice(a + 1, 0, this);
                        this.next = b.next;
                        this.previous = b;
                        b.next = this;
            ...
            (function() {
                ...
                var c = CKEDITOR.tools.extend({table: 1, ul: 1, ol: 1, dl: 1}, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), a = {ol: 1, ul: 1}, e = CKEDITOR.tools.extend({}, {html: 1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, {style: 1, script: 1});
                CKEDITOR.htmlParser.fragment.fromHtml = function(f, d, i) {
                    function l(a) {
                        var b;
                        if (u.length > 0)
                            for (var c = 0; c < u.length; c++) {
                                var d = u[c], h = d.name, g = CKEDITOR.dtd[h], e = k.name &&
                                        CKEDITOR.dtd[k.name];
                    ...
                    var h = new CKEDITOR.htmlParser, g = d instanceof CKEDITOR.htmlParser.element ? d : typeof d == "string" ? new CKEDITOR.htmlParser.element(d) : new CKEDITOR.htmlParser.fragment, u = [], w = [], k = g, t = g.name == "textarea", B = g.name == "pre";
                ...
                CKEDITOR.htmlParser.fragment.prototype = {type: CKEDITOR.NODE_DOCUMENT_FRAGMENT, add: function(a, b) {
                        ...
                        if (this.childrenFilteredBy != a.id) {
                            ...
                            for (var c = 0; c < this.children.length; c++)
                                this.children[c].filter(a) === false && c--
                        }
            ...
            (function() {
                ...
                function f(a) {
                    for (var b =
                        ...
                        if (b)
                            var e = a.type, f = a.name;
                        var n = this[c].apply(window, arguments);
                        if (n === false)
                            return n;
                        if (b) {
                            if (n && (n.name != f || n.type != e))
                                return n
            ...
            (function() {
                function b(b, c) {
                        ...
                        return function(g) {
                            if (g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                                ...
                                if (f = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(g) !== false : c))
                                    if (!p && CKEDITOR.env.ie && g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
                                        f = false;
                                    else if (!p && CKEDITOR.env.ie && (document.documentMode > 7 || g.name in CKEDITOR.dtd.tr || g.name in CKEDITOR.dtd.$listItem))
                                        f = false;
                                    else {
                                        f = a(g);
                    ...
                    function k(a, b) {
                        if ((!p || !CKEDITOR.env.ie) && a.type == CKEDITOR.NODE_ELEMENT && a.name == "br" && !a.attributes["data-cke-eol"])
                            return true;
                        var c;
                        if (a.type ==
                            ...
                            if (CKEDITOR.env.ie && p && (!b || a.parent.name in q))
                                return true;
                            if (!p)
                    ...
                    for (u in q)
                        "#"in F[u] || delete q[u];
                    for (u in q)
                        o.elements[u] = g(p, b.config.fillEmptyBlocks !== false);
                    o.root = g(p);
                    o.elements.br = function(a) {
                        return function(b) {
                            if (b.parent.type !=
                                ...
                                var c = b.attributes;
                                if ("data-cke-bogus"in c || "data-cke-eol"in c)
                                    delete c["data-cke-bogus"];
                                else {
                                    for (c = b.next; c && f(c); )
                                        c = c.next;
                                    var g = e(b);
                ...
                function t(a,
                        b) {
                    for (var c = [], d = b.config.protectedSource, h = b._.dataStore || (b._.dataStore = {id: 1}), g = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g, function(a) {
                ...
                CKEDITOR.htmlDataProcessor = function(a) {
                    ...
                    a.on("toHtml", function(b) {
                        var b = b.data, d = b.dataValue, d = t(d, a), d = h(d, G), d = p(d), d = h(d, I), d = d.replace(Q, "$1cke:$2"), d = d.replace(E, "<cke:$1$2></cke:$1>"), d = CKEDITOR.env.opera ? d : d.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), e = b.context || a.editable().getName(), f;
                ...
                var B = /(?:&nbsp;|\xa0)$/, z = "{cke_protected}", F = CKEDITOR.dtd, s = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], C = CKEDITOR.tools.extend({}, F.$blockLimit, F.$block), r = {elements: {}, attributeNames: [[/^on/, "data-cke-pa-on"]]}, A = {elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/, ""], [/^data-cke-.*/, ""], ["hidefocus",
                            ""]], elements: {$: function(a) {
                            var b = a.attributes;
                            if (b) {
                                if (b["data-cke-temp"])
                ...
                for (var v in{input: 1,
                    textarea: 1}) {
                    r.elements[v] = n;
                    A.elements[v] = q
                }
                var o = /<(a|area|img|input|source)\b([^>]*)>/gi, x = /\s(on\w+|href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, I = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, G = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, D = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, Q = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, L = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, E = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
            })();
            "use strict";
            ...
            CKEDITOR.htmlParser.cssStyle = function(b) {
                ...
                return{rules: c, populate: function(a) {
                        var b = this.toString();
                        if (b)
                            a instanceof CKEDITOR.dom.element ? a.setAttribute("style", b) : a instanceof CKEDITOR.htmlParser.element ? a.attributes.style = b : a.style = b
                    }, toString: function() {
                        var a = [], b;
                        for (b in c)
                            c[b] && a.push(b, ":", c[b], ";");
            ...
            (function() {
                ...
                function a(a) {
                    var b = a.name, c = a.element, e = a.elementMode, m = a.fire("uiSpace", {space: "top", html: ""}).html, n = a.fire("uiSpace", {space: "bottom", html: ""}).html;
                    ...
                    b = CKEDITOR.dom.element.createFromHtml(f.output({id: a.id, name: b, langDir: a.lang.dir, langCode: a.langCode, voiceLabel: [a.lang.editor,
                            a.name].join(", "), topHtml: m ? '<span id="' + a.ui.spaceId("top") + '" class="cke_top cke_reset_all" role="presentation" style="height:auto">' + m + "</span>" : "", contentId: a.ui.spaceId("contents"), bottomHtml: n ? '<span id="' + a.ui.spaceId("bottom") + '" class="cke_bottom cke_reset_all" role="presentation">' + n + "</span>" : "", outerEl: CKEDITOR.env.ie ? "span" : "div"}));
                ...
                CKEDITOR.editor.prototype.resize = function(a, b, c, e) {
                    var f = this.container, n = this.ui.space("contents"), q = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement, e = e ? f.getChild(1) : f;
            ...
            (function() {
                function b(b) {
                    var c = b.editor, d = c.editable(), g = b.data.path, e = g.blockLimit, f = b.data.selection.getRanges()[0], k = c.config.enterMode;
                ...
                CKEDITOR.editable = CKEDITOR.tools.createClass({base: CKEDITOR.dom.element,
                    $: function(a, b) {
                        ...
                        this.setup()
                            ...
                            d(this);
                            var b = this.editor, c = b.getSelection().getStartElement().hasAscendant("pre", true) ? CKEDITOR.ENTER_BR : b.config.enterMode, b = c == CKEDITOR.ENTER_BR, g = CKEDITOR.tools, a = g.htmlEncode(a.replace(/\r\n/g,
                                    "\n")), a = a.replace(/\t/g, "&nbsp;&nbsp; &nbsp;"), c = c == CKEDITOR.ENTER_P ? "p" : "div";
                            if (!b) {
                                var e = /\n{2}/g;
                                if (e.test(a))
                                    var f = "<" + c + ">", k = "</" + c + ">", a = f + a.replace(e, function() {
                                    return k + f
                                }) + k
                            }
                            a = a.replace(/\n/g, "<br>");
                            ...
                            for (var c = this.editor, h = c.config.enterMode,
                                ...
                                if (!j.checkReadOnly()) {
                                    ...
                                    var s, C;
                                    if (k)
                                        for (; (s = j.getCommonAncestor(0, 1)) && (C = CKEDITOR.dtd[s.getName()]) && (!C || !C[f]); )
                                            if (s.getName()in CKEDITOR.dtd.span)
                                                j.splitElement(s);
                                                ...
                                                j.splitBlock(h == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                                    j.insertNode(m);
                                    n ||
                                            (n = m)
                                }
                        ...
                        getData: function(a) {
                            ...
                            if (!this.is("textarea")) {
                                ...
                                this.attachListener(a, "key", function(b) {
                                    ...
                                    if (c in{8: 1, 46: 1}) {
                                        var h = a.getSelection(), b = h.getRanges()[0], g = b.startPath(), e, i, p, c = c == 8;
                                        if (h = f(h)) {
                                            a.fire("saveSnapshot");
                                            ...
                                            if ((e = g.block) && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && (p = e[c ? "getPrevious" : "getNext"](j)) && p.is("table")) {
                                                ...
                                                a.fire("saveSnapshot");
                                                d = 1
                                            } else if ((i = g.contains(["td", "th", "caption"])) && b.checkBoundaryOfElement(i, c ? CKEDITOR.START : CKEDITOR.END))
                                                d = 1
                                    }
                                    return!d
                                });
                ...
                var l = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, j = CKEDITOR.dom.walker.whitespaces(true), m = CKEDITOR.dom.walker.bookmark(false, true);
                ...
                var n = function() {
                            ...
                            if (b(h)) {
                                ...
                                if (w && e in CKEDITOR.dtd.$list)
                                    ...
                                    l == -1 && !f && (l =
                                            j);
                                    f || (u = j);
                                    o.push({isElement: 1, isLineBreak: t, isBlock: h.isBlockBoundary(), hasBlockSibling: g, node: h, name: e, allowed: f});
                                    g = t = 0
                                }
                            } else
                                o.push({isElement: 0, node: h, allowed: 1})
                        }
                        if (l > -1)
                            o[l].firstNotAllowed = 1;
                        if (u > -1)
                            o[u].lastNotAllowed = 1;
                        return o
                    }
                    function d(a, c) {
                    ...
                    function f(a, c) {
                        ...
                        var h = c.endContainer.getChild(c.endOffset), g = c.endContainer.getChild(c.endOffset -
                                1);
                        h && d(h, a[a.length - 1]);
                        if (g && d(g, a[0])) {
                    ...
                    var k = CKEDITOR.dtd, j = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, n = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, m = CKEDITOR.tools.extend({}, k.$inline);
                    delete m.br;
                    return function(j, l, t) {
                        ...
                        if (!A.checkReadOnly()) {
                            var o = (new CKEDITOR.dom.elementPath(A.startContainer,
                                    A.root)).blockLimit || A.root, l = {type: l, dontFilter: v, editable: j, editor: r, range: A, blockLimit: o, mergeCandidates: [], zombies: []}, r = l.range, v = l.mergeCandidates, x, I, G, D;
                            ...
                            for (; (D = b(r.startContainer) && r.startContainer.getChild(r.startOffset - 1)) && b(D) && D.isBlockBoundary() && I.contains(D); )
                            ...
                            for (o = x.startNode; (o = o.getParent()) && g(o); )
                                v.push(o);
                            r.moveToBookmark(x);
                            if (x = t) {
                                x = l.range;
                            ...
                            for (; H = l.mergeCandidates.pop(); )
                                H.mergeSiblings();
                            J.moveToBookmark(P);
                            if (!l.dontMoveCaret) {
                                for (H = b(J.startContainer) && J.startContainer.getChild(J.startOffset - 1); H && b(H) && !H.is(k.$empty); ) {
                                    if (H.isBlockBoundary())
                                        J.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END);
                                    else {
            ...
            (function() {
                ...
                CKEDITOR.on("instanceCreated", function(a) {
                    ...
                    e.on("contentDom", function() {
                        var a = e.document, h = CKEDITOR.document, f = e.editable(), i = a.getBody(), j = a.getDocumentElement(), p = f.isInline(), l;
                        ...
                        if (p ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                            ...
                            f.attachListener(CKEDITOR.env.ie ? f : a.getDocumentElement(), "mouseup", c, e);
                ...
                var q = {img: 1, hr: 1, li: 1, table: 1, tr: 1, td: 1, th: 1, embed: 1, object: 1, ol: 1, ul: 1, a: 1, input: 1, form: 1, select: 1, textarea: 1, button: 1, fieldset: 1, thead: 1, tfoot: 1};
                CKEDITOR.dom.selection.prototype = {getNative: function() {
                        ...
                        if (!c || !c.rangeCount)
                            ...
                            if (d == c.endContainer && d.nodeType == 1 && c.endOffset - c.startOffset == 1 && q[d.childNodes[c.startOffset].nodeName.toLowerCase()])
                                b =
                        ...
                        var a = n ? function() {
                            ...
                            var b = function(b, c) {
                                ...
                                e = j.text.replace(/(\r\n|\r)/g, "\n").length;
                                if (!e)
                                    return{container: d, offset: a(g) + (n > 0 ? 0 : 1)};
                                for (; e > 0; )
                                    try {
                        ...
                        return function(b) {
                            ...
                            if (c.ranges && !b)
                                return c.ranges;
                            if (!c.ranges)
                                c.ranges = new CKEDITOR.dom.rangeList(a.call(this));
                            if (b)
                        ...
                        var b = this, c = CKEDITOR.tools.tryThese(function() {
                            ...
                            for (var a = b.getRanges()[0], c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type ==
                                    CKEDITOR.NODE_ELEMENT && q[c.getName()] && (d = c))); e--)
                        ...
                        if (this.isLocked) {
                            if (a)
                                var b = this.getSelectedElement(), c = !b && this.getRanges();
                            this.isLocked = 0;
                            this.reset();
                            if (a)
                                (a = b || c[0] && c[0].getCommonAncestor()) && a.getAscendant("body", 1) && (b ? this.selectElement(b) : this.selectRanges(c))
                        }
                    }, reset: function() {
                        this._.cache = {}
                        ...
                        if (a.length)
                            if (this.isLocked) {
                                ...
                                if (n) {
                                    var c = CKEDITOR.dom.walker.whitespaces(true), f = /\ufeff|\u00a0/, i = {table: 1, tbody: 1, tr: 1};
                                    if (a.length > 1) {
                                        b = a[a.length - 1];
                                        a[0].setEnd(b.endContainer, b.endOffset)
                                    }
                                    var b = a[0], a = b.collapsed, j, l, m, z = b.getEnclosedNode();
                                    if (z && z.type == CKEDITOR.NODE_ELEMENT && z.getName()in q && (!z.is("a") || !z.getText()))
                                        try {
                ...
                if (!a) {
                    ...
                    this.on("selectionChange", function(b) {
                        for (var c = 0; c < a.length; c++) {
                            var d = a[c], i = d.style.checkActive(b.data.path) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                            d.fn.call(this, i)
                        }
                    })
                }
            ...
            (function() {
                    ...
                    if (a.collapsed) {
                        ...
                        for (m.getPosition(k) == CKEDITOR.POSITION_FOLLOWING && (m = 0); m; ) {
                            ...
                            if (m.equals(k)) {
                                ...
                                var r = m.type, s = r == CKEDITOR.NODE_ELEMENT ? m.getName() : null, q = s && m.getAttribute("contentEditable") == "false", t = s && m.getAttribute("data-nostyle");
                                ...
                                if (!s || i[s] && !t && (!q || h) && (m.getPosition(k) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(m))) {
                                    ...
                                    if (v && ((v.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(v))) {
                                        ...
                                        if (r == CKEDITOR.NODE_TEXT || q || r == CKEDITOR.NODE_ELEMENT && !m.getChildCount()) {
                                            for (var r = m, w; (g = !r.getNext(A)) && (w = r.getParent(), i[w.getName()]) && (w.getPosition(l) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule ||
                                                    e.childRule(w)); )
                                                r = w;
                                            n.setEndAfter(r)
                                        }
                                ...
                                for (var g = u(this, c), q = g.hasAttributes(), t = n.getCommonAncestor(), r = {}, s = {}, v = {}, z = {}, B, C, F; g && t; ) {
                                    if (t.getName() == d) {
                                        for (B in e.attributes)
                                            if (!z[B] && (F = t.getAttribute(C)))
                                                g.getAttribute(B) == F ? s[B] = 1 : z[B] = 1;
                                        for (C in e.styles)
                                            if (!v[C] && (F = t.getStyle(C)))
                                                g.getStyle(C) == F ? r[C] = 1 : v[C] = 1
                                    }
                                    t = t.getParent()
                                }
                                for (B in s)
                ...
                function l(a, b) {
                    ...
                    if (d && !e) {
                        ...
                        f ? b = n(c ? [a.getHtml()] : j(a), b) : a.moveChildren(b);
                    b.replace(a);
                    if (d) {
                        var c = b, i;
                ...
                function k(a, b) {
                    for (var c in a)
                        a[c] = a[c].replace(r, function(a, c) {
                            return b[c]
                        })
                }
                function t(a) {
                ...
                function z(a, b) {
                    for (var c = a.document, d = a.getRanges(), e = b ? this.removeFromRange : this.applyToRange, f, g = d.createIterator(); f = g.getNextRange(); )
                        e.call(this, f);
                    a.selectRanges(d);
                    c.removeCustomData("doc_processing_style")
                }
                var F = {address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1,
                    keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1}, s = {a: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1}, C = /\s*(?:;\s*|$)/, r = /#\((.+?)\)/g, A = CKEDITOR.dom.walker.bookmark(0, 1), v = CKEDITOR.dom.walker.whitespaces(1);
            ...
            (function() {
                ...
                for (c in CKEDITOR.dtd.$blockLimit)
                    c in CKEDITOR.dtd.$list || (b[c] = 1);
                var a = {};
                for (c in CKEDITOR.dtd.$block)
                    c in CKEDITOR.dtd.$blockLimit || c in CKEDITOR.dtd.$empty || (a[c] = 1);
            ...
            CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {type: CKEDITOR.NODE_TEXT, getLength: function() {
                    ...
                    var c = this.$.parentNode, a = c.childNodes.length, e = this.getLength(), f = this.getDocument(), d = new CKEDITOR.dom.text(this.$.splitText(b), f);
            ...
            (function() {
                function b(a, b, c) {
                    var d = a.serializable, i = b[c ? "endContainer" : "startContainer"], l = c ? "endOffset" : "startOffset", j = d ? b.document.getById(a.startNode) : a.startNode, a = d ? b.document.getById(a.endNode) : a.endNode;
                ...
                var c = {createIterator: function() {
                        ...
                        return{getNextRange: function(i) {
                                d = d == void 0 ? 0 : d + 1;
                                var l = a[d];
                                if (l && a.length > 1) {
                                    if (!d)
                                        for (var j = a.length - 1; j >= 0; j--)
                                            c.unshift(a[j].createBookmark(true));
                                    if (i)
                                        for (var m = 0; a[d + m + 1]; ) {
                        ...
                        for (var b =
                        [], c = 0; c < this.length; c++)
                            b.push(this[c].createBookmark2(a));
                        return b
                    }, moveToBookmarks: function(a) {
                        for (var b = 0; b < this.length; b++)
                            this[b].moveToBookmark(a[b])
                    }}
            })();
            (function() {
                function b() {
            ...
            CKEDITOR.plugins.add("dialogui", {onLoad: function() {
                                ...
                                CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "div", null, {role: "presentation"}, function() {
                                    ...
                                    "horizontal" !=
                                            a.labelLayout ? f.push('<label class="cke_dialog_ui_labeled_label' + d + '" ', ' id="' + c.labelId + '"', c.inputId ? ' for="' + c.inputId + '"' : "", (a.labelStyle ? ' style="' + a.labelStyle + '"' : "") + ">", a.label, "</label>", '<div class="cke_dialog_ui_labeled_content"' + (a.controlStyle ? ' style="' + a.controlStyle + '"' : "") + ' role="presentation">', e.call(this, b, a), "</div>") : (d = {type: "hbox", widths: a.widths, padding: 0, children: [{type: "html", html: '<label class="cke_dialog_ui_labeled_label' + d + '" id="' + c.labelId + '" for="' + c.inputId + '"' +
                                                        (a.labelStyle ? ' style="' + a.labelStyle + '"' : "") + ">" + CKEDITOR.tools.htmlEncode(a.label) + "</span>"}, {type: "html", html: '<span class="cke_dialog_ui_labeled_content"' + (a.controlStyle ? ' style="' + a.controlStyle + '"' : "") + ">" + e.call(this, b, a) + "</span>"}]}, CKEDITOR.dialog._.uiElementBuilders.hbox.build(b, d, f));
                                    return f.join("")
                                })
                            }
                            ...
                            if (!(3 > arguments.length)) {
                                ...
                                CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
                                    ...
                                    for (var k = 0, j; k < a.items.length && (j = a.items[k]); k++)
                                        h.push('<option value="', CKEDITOR.tools.htmlEncode(j[1] !== void 0 ? j[1] : j[0]).replace(/"/g, "&quot;"), '" /> ', CKEDITOR.tools.htmlEncode(j[0]));
                                    if (typeof c.inputStyle != "undefined")
                                        c.style = c.inputStyle;
                    ...
                    CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, n, {getInputElement: function() {
                            ...
                            for (c in b)
                                if (d = c.match(a))
                                    this.eventProcessors[c] ? this.eventProcessors[c].call(this, this._.dialog, b[c]) : e(this, this._.dialog, d[1].toLowerCase(), b[c]);
                            return this
                        }, reset: function() {
                            function b() {
                                d.$.open();
                            ...
                            this._.initValue = ""
                        }, eventProcessors: {onChange: function(b,
                                    a) {
            ...
            (function() {
                ...
                function R(a) {
                    var a = CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog", S).output({id: CKEDITOR.tools.getNextNumber(), editorId: a.id, langDir: a.lang.dir, langCode: a.langCode, editorDialogClass: "cke_editor_" + a.name.replace(/\./g, "\\.") + "_dialog", closeTitle: a.lang.common.close})), b = a.getChild([0, 0, 0, 0, 0]), c = b.getChild(0), d = b.getChild(1);
                ...
                CKEDITOR.dialog = function(a, b) {
                    ...
                    function e(b) {
                        if (l ==
                            ...
                            if (9 == c || c == CKEDITOR.SHIFT + 9)
                                c = c == CKEDITOR.SHIFT + 9, l._.tabBarMode ? (c = c ? p.call(l) : u.call(l), l.selectPage(c), l._.tabs[c][0].focus()) : d(c ? -1 : 1), o = 1;
                                ...
                                (c = this.getButton("cancel")) ? CKEDITOR.tools.setTimeout(c.click, 0, c) : !1 !== this.fire("cancel", {hide: !0}).hide && this.hide(), i = 1;
                            else
                                return;
                            g(b)
                        }
                    ...
                    this.on("cancel", function(b) {
                        C(function(c) {
                            if (c.isChanged())
                                return confirm(a.lang.common.confirmCancel) || (b.data.hide = !1), !0
                        })
                    },
                            this, null, 0);
                ...
                CKEDITOR.dialog.prototype = {destroy: function() {
                        ...
                        return function(a, b) {
                            if (!this._.contentSize || !(this._.contentSize.width == a && this._.contentSize.height == b))
                                CKEDITOR.dialog.fire("resize", {dialog: this, width: a, height: b}, this._.editor), this.fire("resize", {width: a, height: b}, this._.editor), this.parts.contents.setStyles({width: a + "px", height: b + "px"}), "rtl" == this._.editor.lang.dir && this._.position && (this._.position.x =
                        ...
                        if (!g || !this._.position || !(this._.position.x ==
                                a && this._.position.y == b))
                            this._.position = {x: a, y: b}, g || (g = CKEDITOR.document.getWindow().getScrollPosition(), a += g.x, b += g.y), e && (g = this.getSize(), a = CKEDITOR.document.getWindow().getViewPaneSize().width - g.width - a), b = {top: (0 < b ? b : 0) + "px"}, b[e ? "right" : "left"] = (0 < a ? a : 0) + "px", d.setStyles(b), c && (this._.moved = 1)
                    ...
                    commitContent: function() {
                        ...
                        if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                            for (var b = [], c = a.label ? ' title="' + CKEDITOR.tools.htmlEncode(a.label) + '"' : "", d = CKEDITOR.dialog._.uiElementBuilders.vbox.build(this, {type: "vbox", className: "cke_dialog_page_contents", children: a.elements, expand: !!a.expand, padding: a.padding, style: a.style || "width: 100%;"}, b), e = this._.contents[a.id] = {}, g = d.getChild(), f = 0; d = g.shift(); )
                                !d.notAllowed && ("hbox" !=
                ...
                var G, w = {}, r, t = {}, M = function(a) {
                    ...
                    if ((b = t[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + e]) && b.length)
                        b = b[b.length - 1], b.keydown && b.keydown.call(b.uiElement, b.dialog,
                ...
                (function() {
                    CKEDITOR.ui.dialog = {uiElement: function(a, b, c, d, e, g, f) {
                            if (!(4 > arguments.length)) {
                                ...
                                for (var l = h["class"] && h["class"].split ? h["class"].split(" ") : [], i = 0; i < l.length; i++)
                                    l[i] && (n[l[i]] = 1);
                                l = [];
                                for (i in n)
                                    l.push(i);
                                ...
                                for (i in h)
                                    m.push(i + '="' + CKEDITOR.tools.htmlEncode(h[i]) + '" ');
                                m.push(">", o, "</", k, ">");
                                c.push(m.join(""));
                ...
                CKEDITOR.ui.dialog.uiElement.prototype = {getElement: function() {
                        ...
                        for (e in a)
                            if (c = e.match(b))
                                this.eventProcessors[e] ? this.eventProcessors[e].call(this, this._.dialog, a[e]) : d(this, this._.dialog, c[1].toLowerCase(), a[e]);
                        return this
            ...
            (function() {
                CKEDITOR.plugins.add("a11yhelp", {requires: "dialog", availableLangs: {ar: 1, bg: 1, ca: 1, cs: 1, cy: 1, da: 1, de: 1, el: 1, en: 1, eo: 1, es: 1, et: 1, fa: 1, fi: 1, fr: 1, "fr-ca": 1, gl: 1, gu: 1, he: 1, hi: 1, hr: 1, hu: 1, it: 1, ja: 1, km: 1, ku: 1, lt: 1, lv: 1, mk: 1, mn: 1, nb: 1, nl: 1, no: 1, pl: 1, pt: 1, "pt-br": 1, ro: 1, ru: 1, si: 1, sk: 1, sl: 1, sq: 1, sv: 1, th: 1, tr: 1, ug: 1, uk: 1, vi: 1, "zh-cn": 1}, init: function(b) {
                        var c = this;
                        b.addCommand("a11yHelp", {exec: function() {
                                var a = b.langCode, a = c.availableLangs[a] ? a : c.availableLangs[a.replace(/-.*/, "")] ? a.replace(/-.*/,
                                        "") : "en";
            ...
            (function() {
                ...
                CKEDITOR.plugins.add("dialogadvtab", {requires: "dialog", allowedContent: function(c) {
                        ...
                        a || (a = i);
                        var d = c.lang.common, h = {id: "advanced", label: d.advancedTab, title: d.advancedTab, elements: [{type: "vbox", padding: 1, children: []}]}, e = [];
                        if (a.id || a.dir)
                            a.id && e.push({id: "advId", att: "id", type: "text", requiredContent: b ? b + "[id]" : null, label: d.id, setup: f, commit: g}), a.dir && e.push({id: "advLangDir", att: "dir", type: "select", requiredContent: b ? b + "[dir]" : null, label: d.langDir, "default": "",
                                style: "width:100%", items: [[d.notSet, ""], [d.langDirLTR, "ltr"], [d.langDirRTL, "rtl"]], setup: f, commit: g}), h.elements[0].children.push({type: "hbox", widths: ["50%", "50%"], children: [].concat(e)});
                        if (a.styles || a.classes)
                            e = [], a.styles && e.push({id: "advStyles", att: "style", type: "text", requiredContent: b ? b + "{cke-xyz}" : null, label: d.styles, "default": "", validate: CKEDITOR.dialog.validate.inlineStyle(d.invalidInlineStyle), onChange: function() {
            ...
            (function() {
                function n(a, f, d, b) {
                    if (!a.isReadOnly() && !a.equals(d.editable())) {
                        ...
                        if ((b ? a.getComputedStyle("direction") : a.getStyle("direction") || a.hasAttribute("dir")) != f)
                            a.removeStyle("direction"), b ? (a.removeAttribute("dir"), f != a.getComputedStyle("direction") &&
                ...
                for (var j = CKEDITOR.dom.element.prototype, l = ["setStyle", "removeStyle", "setAttribute", "removeAttribute"], k = 0; k < l.length; k++)
            ...
            (function() {
                function w(a) {
                    ...
                    function l() {
                        if (CKEDITOR.env.ie &&
                            ...
                            if (d.getType() == CKEDITOR.SELECTION_ELEMENT && (b = d.getSelectedElement()))
                                c = d.getRanges()[0], e = a.document.createText(""), e.insertBefore(b), c.setStartBefore(e), c.setEndAfter(b), d.selectRanges([c]), setTimeout(function() {
                        ...
                        if (!c.getById("cke_pastebin")) {
                            ...
                            setTimeout(function() {
                                if (CKEDITOR.env.webkit || CKEDITOR.env.opera)
                                    CKEDITOR.document[CKEDITOR.env.webkit ? "getBody" : "getDocumentElement"]().$.scrollTop = m;
                                k && k.removeListener();
                                CKEDITOR.env.ie && e.focus();
                                f.selectBookmarks(h);
                                i.remove();
                                var d;
                                if (CKEDITOR.env.webkit && (d = i.getFirst()) && d.is && d.hasClass("Apple-style-span"))
                                    i = d;
                    ...
                    function o() {
                        if (CKEDITOR.env.ie) {
                            ...
                            d.lock();
                            if (a.editable().fire(q) && !k("paste"))
                                return d.unlock(), !1;
                            d.unlock()
                        } else
                            try {
                                if (a.editable().fire(q) && !a.document.$.execCommand("Paste", !1, null))
                                    throw 0;
                            } catch (b) {
                                return!1
                            }
                    ...
                    function n(b) {
                        ...
                        if ("Paste" == b) {
                            ...
                            b = a.getSelection(), c = b.getRanges(), c = b.getType() != CKEDITOR.SELECTION_NONE && !(1 == c.length && c[0].collapsed);
                ...
                function y(a, b) {
                    ...
                    if ((CKEDITOR.env.gecko || CKEDITOR.env.opera) && a.enterMode != CKEDITOR.ENTER_BR)
                        CKEDITOR.env.gecko && (b = b.replace(/^<br><br>$/, "<br>")), -1 < b.indexOf("<br><br>") && (b = "<p>" + b.replace(/(<br>){2,}/g, function(a) {
                            return e(a.length / 4)
                        }) + "</p>");
                    return p(a, b)
                }
                        ...
                        a.on("paste", function(a) {
                            ...
                            if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                                ...
                                for (g.setHtml(b); 1 == g.getChildCount() && (h =
                                        g.getFirst()) && h.type == CKEDITOR.NODE_ELEMENT && (h.hasClass("cke_editable") || h.hasClass("cke_contents")); )
                                    g = k = h;
            ...
            CKEDITOR.plugins.colordialog = {requires: "dialog", init: function(b) {
                    ...
                    b.getColorFromDialog = function(e, f) {
                        ...
                        if (b._.storedDialogs && b._.storedDialogs.colordialog)
                            d(b._.storedDialogs.colordialog);
                        else
            ...
            CKEDITOR.plugins.add("menu", {requires: "floatpanel", beforeInit: function(k) {
                    for (var g = k.config.menu_groups.split(","), m = k._.menuGroups = {}, l = k._.menuItems = {}, a = 0; a < g.length; a++)
                        m[g[a]] = a + 1;
            ...
            (function() {
                function w(a) {
                    ...
                    function i() {
                        var b = {}, c, f, e;
                        for (c in a.ui.items)
                            f = a.ui.items[c], e = f.toolbar || "others", e = e.split(","), f = e[0], e = parseInt(e[1] || -1, 10), b[f] || (b[f] = []), b[f].push({name: c, order: e});
                        for (f in b)
                ...
                function n(a) {
                    return a._.toolbarGroups || (a._.toolbarGroups = [{name: "document", groups: ["mode", "document", "doctools"]}, {name: "clipboard", groups: ["clipboard", "undo"]}, {name: "editing", groups: ["find", "selection", "spellchecker"]}, {name: "forms"}, "/", {name: "basicstyles", groups: ["basicstyles", "cleanup"]}, {name: "paragraph", groups: ["list",
                                "indent", "blocks", "align"]}, {name: "links"}, {name: "insert"}, "/", {name: "styles"}, {name: "colors"}, {name: "tools"}, {name: "others"}, {name: "about"}])
                }
                var t = function() {
                    this.toolbars = [];
                        ...
                        var d, i = function(c, h) {
                            ...
                            switch (h) {
                                ...
                                case 40:
                                    b = c;
                                    do
                                        b = b.next, !b && g && (b = c.toolbar.items[0]);
                                    while (b && !b.focus);
                                    b ? b.focus() : i(c, 9);
                                    return!1;
                                case e ? 39 : 37:
                                case 38:
                                    b = c;
                                    do
                                        b = b.previous, !b && g && (b = c.toolbar.items[c.toolbar.items.length - 1]);
                                    while (b && !b.focus);
                                    ...
                                    if (m)
                                        if (e && (b.push("</span>"),
                                            ...
                                            for (var s = 0; s < r.length; s++) {
                                                var o = r[s], u;
                                                if (o)
                                                    if (o.type == CKEDITOR.UI_SEPARATOR)
                                                        g = e && o;
                                                    else {
                                                        u = !1 !== o.canGroup;
                                                        if (!l) {
            ...
            (function() {
                function C(c, j, f) {
                    ...
                    for (h = 0; h < e.length; h++)
                        g = e[h].getCustomData("listarray_index"), i[g].indent = -1;
                    for (h = g + 1; h < i.length; h++)
                        if (i[h].indent > i[h - 1].indent + 1) {
                            e = i[h - 1].indent + 1 - i[h].indent;
                            for (g = i[h].indent; i[h] && i[h].indent >= g; )
                                i[h].indent += e, h++;
                            h--
                        }
                ...
                function y(c, j, f, b) {
                    for (var i, e; i = c[b?"getLast":"getFirst"](D); )
                        (e = i.getDirection(1)) !== j.getDirection(1) && i.setAttribute("dir", e), i.remove(), f ? i[b ? "insertBefore" : "insertAfter"](f) : j.append(i, b)
                }
                function A(c) {
                    var j;
                    (j = function(f) {
                ...
                function v(c, j, f) {
                    ...
                    if (a && (b = w(a)))
                        e.contains(a) ? (y(b, a.getParent(), a), b.remove()) : e.append(b);
                    for (; f.checkStartOfBlock() && f.checkEndOfBlock(); )
                        g = f.startPath(), b = g.block, b.is("li") && (e = b.getParent(), b.equals(e.getLast(q)) && b.equals(e.getFirst(q)) && (b = e)), f.moveToPosition(b, CKEDITOR.POSITION_BEFORE_START), b.remove();
                    f = f.clone();
                    b = c.editable();
                ...
                CKEDITOR.plugins.list = {listToArray: function(c, j, f, b, i) {
                        ...
                        for (var e = 0, h = c.getChildCount(); e < h; e++) {
                            ...
                            if ("li" == g.$.nodeName.toLowerCase()) {
                                ...
                                f.push(a);
                                for (var d =
                                        0, m = g.getChildCount(), k; d < m; d++)
                                    k = g.getChild(d), k.type == CKEDITOR.NODE_ELEMENT && r[k.getName()] ? CKEDITOR.plugins.list.listToArray(k, j, f, b + 1, a.grandparent) : a.contents.push(k)
                            }
                        }
                        return f
                        ...
                        for (var e, h = c[f].parent.getDocument(), g = new CKEDITOR.dom.documentFragment(h), a = null, d = f, m = Math.max(c[f].indent, 0), k = null, n, l, p = b == CKEDITOR.ENTER_P ? "p" : "div"; ; ) {
                            ...
                            if (o.indent == m) {
                                if (!a || c[d].parent.getName() !=
                                        a.getName())
                                    a = c[d].parent.clone(!1, 1), i && a.setAttribute("dir", i), g.append(a);
                                k = a.append(o.element.clone(0, 1));
                                n != a.getDirection(1) && k.setAttribute("dir", n);
                                for (e = 0; e < o.contents.length; e++)
                                    k.append(o.contents[e].clone(1, 1));
                                d++
                            } else if (o.indent == Math.max(m, 0) + 1)
                                l = c[d - 1].element.getDirection(1), d = CKEDITOR.plugins.list.arrayToList(c, null, d, b, l != n ? n : null), !k.getChildCount() && (CKEDITOR.env.ie && !(7 < h.$.documentMode)) && k.append(h.createText(" ")), k.append(d.listNode), d = d.nextIndex;
                            else if (-1 == o.indent &&
                                    !f && e) {
                                ...
                                for (e = 0; e < x; e++) {
                                    ...
                                    if (t.type == CKEDITOR.NODE_ELEMENT && t.isBlockBoundary()) {
                                        ...
                                        w && (l || (l = h.createElement(p), a && l.setAttribute("dir", n)), u && l.setAttribute("style", u), z && l.setAttribute("class", z), l.append(t.clone(1, 1)));
                        ...
                        if (j)
                            for (c = g.getFirst(); c; ) {
                                if (c.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(j, c), c.getName()in CKEDITOR.dtd.$listItem && (f = c, h = i = b = void 0, b = f.getDirection()))) {
                                    for (i = f.getParent(); i && !(h = i.getDirection()); )
                                        i = i.getParent();
                ...
                x.prototype = {exec: function(c) {
                        ...
                        if (this.state == CKEDITOR.TRISTATE_OFF) {
                            ...
                            if (i.getFirst(q)) {
                                ...
                                j.enterMode == CKEDITOR.ENTER_BR ? i.appendBogus() : b[0].fixBlock(1, j.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), f.selectRanges(b)
                        }
                        for (var j =
                            ...
                            if (d = i.shift(), this.state == CKEDITOR.TRISTATE_OFF)
                                if (r[d.root.getName()]) {
                                    ...
                                    for (e = 0; e < b.contents.length; e++)
                                        if (l = b.contents[e], (l = l.getAscendant("li", !0)) && !l.getCustomData("list_item_processed"))
                                    ...
                                    for (l = 0; l < k.length; l++)
                                        a = a.getCommonAncestor(k[l].getParent());
                                ...
                                this.state == CKEDITOR.TRISTATE_ON && r[d.root.getName()] && C.call(this, c, d, h);
                    ...
                    exec: function(d) {
                        function i(n) {
                            for (var j = l.startContainer, b = l.endContainer; j && !j.getParent().equals(n); )
                                j = j.getParent();
                            for (; b && !b.getParent().equals(n); )
                                b = b.getParent();
                            if (j && b) {
                                for (var c = j, j = [], a = !1; !a; )
                                    c.equals(b) && (a = !0), j.push(c), c = c.getNext();
                                if (!(1 > j.length)) {
                                    c = n.getParents(!0);
                                    for (b = 0; b < c.length; b++)
                                    ...
                                    if (h && h.length)
                                        for (b = 0; b < h.length; b++) {
                                            for (g = n = h[b]; (g = g.getNext()) && g.is && g.getName()in m; )
                                                CKEDITOR.env.ie && !n.getFirst(function(b) {
                                                    return t(b) && u(b)
                        ...
                        function a() {
                            ...
                            for (var b; b = a.getNextParagraph(e == CKEDITOR.ENTER_P?"p":"div"); )
                                f(b)
                        }
                        function f(a, g) {
            ...
            (function() {
                ...
                function p(a) {
                    for (var a = a.getSelection().getRanges(!0), d = a.length - 1; 0 < d; d--)
                        a[d].deleteContents();
                    return a[0]
                }
                ...
                CKEDITOR.plugins.enterkey = {enterBlock: function(a, d, b, i) {
                        if (b = b || p(a)) {
                            ...
                            if (l) {
                                ...
                                if (a)
                                    g = a.getParent(), g.is("li") && (a.breakParent(g),
                                            a.move(a.getNext(), 1));
                                ...
                                if (!j && !h) {
                                    ...
                                    var k;
                                    if (d) {
                                        if (d.is("li") || !q.test(d.getName()) && !d.is("pre"))
                                            e = d.clone()
                                    } else
                                        a && (e = a.clone());
                                    ...
                                    if (f = l.elementPath) {
                                        ...
                                        for (g = f.elements.length; i < g; i++) {
                                            k = f.elements[i];
                                            if (k.equals(f.block) || k.equals(f.blockLimit))
                                                break;
            ...
            (function() {
                ...
                CKEDITOR.on("dialogDefinition", function(a) {
                    for (var c = a.data.definition, d, b = 0; b < c.contents.length; ++b)
                        if (d = c.contents[b])
                            j(a.editor, a.data.name, c, d.elements), d.hidden && d.filebrowser && (d.hidden =
            ...
            CKEDITOR.plugins.add("forms", {requires: "dialog,fakeobjects", onLoad: function() {
                    ...
                    b.contextMenu && (!b.blockless && b.contextMenu.addListener(function(g, c, a) {
                        if ((g = a.contains("form", 1)) && !g.isReadOnly())
                        ...
                        if (a && !a.isReadOnly()) {
                            ...
                            if (c == "img" && a.data("cke-real-element-type") == "hiddenfield")
                                return{hiddenfield: CKEDITOR.TRISTATE_OFF}
                        }
                    }));
                    b.on("doubleclick", function(a) {
                        var c = a.data.element;
                        if (!b.blockless && c.is("form"))
                            a.data.dialog = "form";
                        else if (c.is("select"))
                            a.data.dialog = "select";
                        else if (c.is("textarea"))
                            a.data.dialog = "textarea";
            ...
            CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({base: CKEDITOR.htmlParser.basicWriter, $: function() {
                    ...
                    for (a in CKEDITOR.tools.extend({}, b.$nonBodyContent, b.$block, b.$listItem, b.$tableContent))
                        this.setRules(a, {indent: !b[a]["#"], breakBeforeOpen: 1, breakBeforeClose: !b[a]["#"], breakAfterClose: 1, needsSpace: a in
            ...
            (function() {
                ...
                function m(a) {
                    if (!a.readOnly) {
                        var d =
                                a.window, b = a.document, c = b.getBody(), e = c.getFirst(), f = c.getChildren().count();
                        if (!f || 1 == f && e.type == CKEDITOR.NODE_ELEMENT && e.hasAttribute("_moz_editor_bogus_node")) {
                            n(a);
                            var e = CKEDITOR.document, g = e.getDocumentElement(), h = g.$.scrollTop, i = g.$.scrollLeft, j = b.$.createEvent("KeyEvents");
                ...
                CKEDITOR.plugins.add("wysiwygarea", {init: function(a) {
                        ...
                        a.addMode("wysiwyg", function(d) {
                            ...
                            var c = "document.open();" + (CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain + ")();" : "") + "document.close();",
                                    c = CKEDITOR.env.air ? "javascript:void(0)" : CKEDITOR.env.ie ? "javascript:void(function(){" + encodeURIComponent(c) + "}())" : "", e = CKEDITOR.dom.element.createFromHtml('<iframe src="' + c + '" frameBorder="0"></iframe>');
                            ...
                            e.setAttributes({"aria-describedby": i, title: g, tabIndex: a.tabIndex, allowTransparency: "true"});
                            !c && b();
                ...
                var k = CKEDITOR.tools.createClass({$: function(a) {
                        this.base.apply(this, arguments);
                        ...
                        this._.docTitle = this.getWindow().getFrame().getAttribute("title")
                            ...
                            if (d)
                                ...
                                b._.dataStore = {id: 1};
                                var c = b.config, e = c.fullPage, f = c.docType, g = CKEDITOR.tools.buildStyleHtml(o()).replace(/<style>/,
                            ...
                            if (a)
                                return this.getHtml();
                            var a = this.editor, d = a.config, b = d.fullPage, c = b && a.docType, e = b && a.xmlDeclaration, f = this.getDocument(), b = b ? f.getDocumentElement().getOuterHtml() : f.getBody().getHtml();
            ...
            (function() {
                ...
                CKEDITOR.plugins.add("image", {requires: "dialog", init: function(b) {
                        ...
                        b.addCommand("image", new CKEDITOR.dialogCommand("image", {allowedContent: a, requiredContent: "img[alt,src]", contentTransformations: [["img{width}: sizeToStyle", "img[width]: sizeToAttribute"], ["img{float}: alignmentToStyle", "img[align]: alignmentToAttribute"]]}));
            ...
            (function() {
                ...
                function j(a) {
                    ...
                    for (var g = new CKEDITOR.dom.walker(b), d; d = g.next(); )
                        if (d.type == CKEDITOR.NODE_ELEMENT)
                            if (!d.equals(a.data.node) && d.getDirection())
                                b.setStartAfter(d), g = new CKEDITOR.dom.walker(b);
                            else {
            ...
            CKEDITOR.plugins.add("link", {requires: "dialog,fakeobjects", onLoad: function() {
                    ...
                    b.on("doubleclick", function(a) {
                        ...
                        if (!c.isReadOnly())
                            ...
                            } else if (CKEDITOR.plugins.link.tryRestoreFakeAnchor(b, c))
                    ...
                    b.contextMenu && b.contextMenu.addListener(function(a) {
                        ...
                        if (!a && !(a = CKEDITOR.plugins.link.getSelectedLink(b)))
                            return null;
                        var c = {};
            ...
            CKEDITOR.removeAnchorCommand.prototype = {exec: function(b) {
                    ...
                    if (a && (c = a.getSelectedElement()) && (CKEDITOR.plugins.link.fakeAnchor && !c.getChildCount() ? CKEDITOR.plugins.link.tryRestoreFakeAnchor(b, c) : c.is("a")))
                        c.remove(1);
                    else if (c = CKEDITOR.plugins.link.getSelectedLink(b))
                        c.hasAttribute("href") ? (c.removeAttributes({name: 1, "data-cke-saved-name": 1}), c.removeClass("cke_anchor")) : c.remove(1);
                    a.selectBookmarks(d)
            ...
            (function() {
                ...
                function ca(a) {
                    ...
                    p(d, {attach: function() {
                            ...
                            for (var Q in g)
                                g[Q] = CKEDITOR.tools.cssLength(g[Q]);
                            this.setStyles(g)
                        }, look: function(a) {
                            if (this.oldLook != a) {
                    ...
                    for (b = d.lineChildren.length; b--; )
                        d.lineChildren[b].appendTo(d);
                    d.look(r);
                    d.appendTo(d.wrap);
                    d.unselectable();
                ...
                function u(a, b) {
                    if (!b || !(b.type == CKEDITOR.NODE_ELEMENT && b.$))
                        return!1;
                    var d =
                            a.line;
                ...
                function o(a) {
                    ...
                    var b;
                    if (!(b = T(a)))
                        l(a) ? (b = {left: 1, right: 1, center: 1}, b = !(!b[a.getComputedStyle("float")] && !b[a.getAttribute("align")])) : b = !1;
                    return b
                }
                function T(a) {
                ...
                function W(a) {
                    ...
                    if (b.y > f.size.top - 1 && b.y < f.size.top + e)
                        i = !1;
                    else if (b.y > f.size.bottom - e && b.y < f.size.bottom + 1)
                        i = !0;
                    else
                        return null;
                    if (o(f) ||
                            ea(a, f, i) || f.getParent().is(X))
                        return null;
                    var h = q(a, f, !i);
                    if (h) {
                        if (h && h.type == CKEDITOR.NODE_TEXT)
                            return null;
                        if (l(h)) {
                            if (o(h) || !E(a, h) || h.getParent().is(X))
                                return null;
                            c = [h, f][i ? "reverse" : "concat"]().concat([L, F])
                        }
                    } else
                        f.equals(a.editable[i ? "getLast" : "getFirst"](a.isRelevant)) ? (B(a), i && b.y > f.size.bottom - e && b.y < d.pane.height && f.size.bottom > d.pane.height - e && f.size.bottom < d.pane.height ? j = x : 0 < b.y && b.y < f.size.top + e && (j = w)) : j = r, c = [null, f][i ? "reverse" : "concat"]().concat([i ? V : C, F, j, f.equals(a.editable[i ?
                ...
                function M(a, b, d, e) {
                    ...
                    }(), c = b.getDocumentPosition(), j = {}, i = {}, h = {}, k = {}, g = s.length; g--; )
                        j[s[g]] = parseInt(f("border-" + s[g] + "-width"), 10) || 0, h[s[g]] = parseInt(f("padding-" + s[g]), 10) || 0, i[s[g]] = parseInt(f("margin-" + s[g]), 10) || 0;
                    (!d || e) &&
                            G(a, e);
                ...
                CKEDITOR.plugins.add("magicline", {init: function(a) {
                        ...
                        a.on("contentDom", function() {
                            ...
                            b.is(v.$inline) || (c.inInlineMode &&
                                    !T(b) && b.setStyles({position: "relative", top: null, left: null}), ca.call(this, c), G(c), b.attachListener(a, "beforeUndoImage", function() {
                                c.line.detach()
                                ...
                                if ("wysiwyg" == a.mode)
                                    if (c.inInlineMode) {
                                        ...
                                        var e = c.view.editable,
                                                f = c.view.scroll;
                                        if (!(d > e.left - f.x && d < e.right - f.x) || !(b > e.top - f.y && b < e.bottom - f.y))
                                ...
                                if (!("wysiwyg" != a.mode || a.readOnly ||
                                    ...
                                    h = setTimeout(function() {
                                        ...
                                        h = c.trigger = null;
                                        G(c);
                                        if (i && !c.hiddenMode && a.focusManager.hasFocus && !c.line.mouseNear() && (c.element = Z(c, !0)))
                                            (c.trigger = U(c) || W(c) || $(c)) ? c.line.attach().place() : (c.trigger = null, c.line.detach()), i = !1
                                    }, 30)
                                }
                                ...
                                c.hiddenMode = 0
                            }), a.addCommand("accessPreviousSpace", R(c)), a.addCommand("accessNextSpace", R(c, !0)), a.setKeystroke([[d.magicline_keystrokePrevious, "accessPreviousSpace"], [d.magicline_keystrokeNext, "accessNextSpace"]]), a.on("loadSnapshot", function() {
                ...
                var Z = function() {
                    ...
                    function a(a) {
                        ...
                        if (N(a, f, c))
                            return j.set(L, aa);
                        if (f && e.contains(f))
                            for (; !f.getParent().equals(e); )
                                f = f.getParent();
                        else
                            f = e.getFirst(function(c) {
                                return b(a, c)
                            });
                        if (c && e.contains(c))
                            for (; !c.getParent().equals(e); )
                                c = c.getParent();
                        else
                            c = e.getLast(function(c) {
                                return b(a, c)
                            });
                        if (!f || !c)
                            return null;
                        m(a, f);
                        m(a, c);
                        if (!(a.mouse.y > f.size.top && a.mouse.y < c.size.bottom))
                            return null;
                        ...
                        if (!k || !g || !(a.mouse.y > k.size.top && a.mouse.y < g.size.bottom))
                            return null;
                        j.upper = k;
                        j.lower = g;
                        return j.set(L, aa)
            ...
            CKEDITOR.plugins.add("pagebreak", {requires: "fakeobjects", onLoad: function() {
                    ...
                    a && a.addRules({elements: {div: function(a) {
                                ...
                                if ((d = d && "span" == d.name && d.attributes.style) && /page-break-after\s*:\s*always/i.test(e) && /display\s*:\s*none/i.test(d))
                                    c.contenteditable = "false", c["class"] = "cke_pagebreak", c["data-cke-display-name"] = "pagebreak", c["aria-label"] = b, c.title = b, a.children.length = 0
                            }}})
                }});
            ...
            (function() {
                var h, i = {modes: {wysiwyg: 1, source: 1}, canUndo: !1, readOnly: 1, exec: function(a) {
                        ...
                        if (b.fullPage)
                            g = a.getData().replace(/<head>/, "$&" + e).replace(/[^>]*(?=<\/title>)/, "$& &mdash; " + a.lang.preview.preview);
                        else {
                        ...
                        if (!a.fire("contentPreview", a = {dataValue: g}))
                            return!1;
                        c = "";
                            ...
                            for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), e = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), f = CKEDITOR.plugins.removeformat.filter, k = a.getSelection().getRanges(1), l = k.createIterator(), c; c = l.getNextRange(); ) {
                                ...
                                if (j) {
                                    ...
                                    for (b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); b && !b.equals(j); )
                                        d = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), !("img" == b.getName() && b.data("cke-realelement")) && f(a, b) && (h.test(b.getName()) ? b.remove(1) : (b.removeAttributes(e), a.fire("removeFormatCleanup", b))), b = d
                                }
                                c.moveToBookmark(i)
                            }
                            a.forceNextSelectionCheck();
            ...
            CKEDITOR.plugins.add("specialchar", {availableLangs: {bg: 1, ca: 1, cs: 1, cy: 1, de: 1, el: 1, en: 1, eo: 1, es: 1, et: 1, fa: 1, fi: 1, fr: 1, "fr-ca": 1, gl: 1, he: 1, hr: 1, hu: 1, it: 1, ku: 1, lv: 1, nb: 1, nl: 1, no: 1, pl: 1, "pt-br": 1, ru: 1, si: 1, sk: 1, sq: 1, sv: 1, th: 1, tr: 1, ug: 1, "zh-cn": 1}, requires: "dialog", init: function(a) {
                    var c = this;
                    CKEDITOR.dialog.add("specialchar", this.path + "dialogs/specialchar.js");
                    a.addCommand("specialchar", {exec: function() {
                            var b = a.langCode, b = c.availableLangs[b] ? b : c.availableLangs[b.replace(/-.*/, "")] ? b.replace(/-.*/, "") :
                                    "en";
            ...
            (function() {
                ...
                var i = "", r = function() {
                    ...
                    var b = this, f = function() {
                        if (!("undefined" != typeof d.instances[b.name] || null != d.instances[b.name])) {
                            ...
                            if (c = d.instances[b.name])
                                o.sLang = c.sLang, o.option(c.option()), o.paused = c.paused;
                ...
                CKEDITOR.plugins.scayt = {engineLoaded: !1, instances: {}, controlInfo: {}, setControlInfo: function(a, c) {
                        ...
                        if (a &&
                                a.name && this.controlInfo[a.name])
                            return this.controlInfo[a.name].paused
                    }, getScayt: function(a) {
                        ...
                        b[3] = "1";
                        for (var d = 0; 4 > d; d++)
                            c[d] = "undefined" != typeof window.scayt && "undefined" != typeof window.scayt.uiTags ? parseInt(b[d],
                        ...
                        if (!0 === this.engineLoaded)
                            return r.apply(a);
                        if (-1 == this.engineLoaded)
                ...
                var d = CKEDITOR.plugins.scayt, s = function(a, c, b, d, e, k, g) {
                    ...
                    a.addMenuItem(d, {label: b, command: d, group: k, order: g})
                        ...
                        if (d.isScaytReady(a)) {
                            ...
                            !a.config.scayt_autoStartup && 0 <= d.engineLoaded && (a.focus(), this.setState(CKEDITOR.TRISTATE_DISABLED),
                                    d.loadEngine(a))
                    }};
                CKEDITOR.plugins.add("scayt", {requires: "menubutton,dialog", beforeInit: function(a) {
                        ...
                        a.contextMenu && a.addMenuItems && a.contextMenu.addListener(function(b, c) {
                            if (!d.isScaytEnabled(a) || c.getRanges()[0].checkReadOnly())
                                return null;
                        ...
                        if (a.config.scayt_autoStartup)
                            a.on("instanceReady", function() {
                                d.loadEngine(a)
                            })
                    }, afterInit: function(a) {
                        var c, b = function(a) {
                            if (a.hasAttribute("data-scaytid"))
                                return!1
                        };
                ...
                CKEDITOR.plugins.add("stylescombo", {requires: "richcombo", init: function(c) {
                        ...
                        c.on("stylesSet", function(b) {
                            if (b = b.data.styles) {
                                for (var a, h, d = 0, e = b.length; d < e; d++)
                                    if (a = b[d], !(c.blockless && a.element in CKEDITOR.dtd.$block) && (h = a.name, a = new CKEDITOR.style(a), !c.filter.customConfig || c.filter.check(a)))
                                        a._name = h, a._.enterMode = j.enterMode, a._.weight = d + 1E3 * (a.type == CKEDITOR.STYLE_OBJECT ? 1 : a.type == CKEDITOR.STYLE_BLOCK ? 2 : 3), g[h] = a, i.push(a), k.push(a);
                                i.sort(function(a, b) {
                        ...
                        c.ui.addRichCombo("Styles", {label: f.label, title: f.panelTitle, toolbar: "styles,10", allowedContent: k, panel: {css: [CKEDITOR.skin.getPath("editor")].concat(j.contentsCss), multiSelect: !0, attributes: {"aria-label": f.panelTitle}}, init: function() {
                                ...
                                for (g = i.length; e < g; e++)
                                    b = i[e], a = b._name, d = b.type, d != c && (this.startGroup(f["panelTitle" + d]), c = d), this.add(a, b.type == CKEDITOR.STYLE_OBJECT ? a : b.buildPreview(), a);
                                this.commit()
                            }, onClick: function(b) {
                                c.focus();
                                c.fire("saveSnapshot");
                        ...
                        if (f.collapsed)
                            ...
                            for (f.guard = d; g = f.next(); )
                                if (g.type != CKEDITOR.NODE_ELEMENT || !g.is(CKEDITOR.dtd.table))
                                    if ((g =
                                            g.getAscendant("td", !0) || g.getAscendant("th", !0)) && !g.getCustomData("selected_cell"))
            ...
            (function() {
                ...
                h.prototype = {equals: function(a, c) {
                        ...
                        b = a.bookmarks;
                        if (d || b) {
                            if (!d || !b || d.length != b.length)
                                return!1;
                            for (var e = 0; e < d.length; e++) {
                                var f = d[e], g = b[e];
                                if (f.startOffset != g.startOffset || f.endOffset != g.endOffset || !CKEDITOR.tools.arrayCompare(f.start, g.start) || !CKEDITOR.tools.arrayCompare(f.end, g.end))
                                    return!1
                            }
                        }
                        return!0
                ...
                i.prototype = {type: function(a) {
                        ...
                        if (!1 === c.contents || this.currentImage && c.equals(this.currentImage, a))
                            return!1;
            ...
            CKEDITOR.plugins.add("wsc", {requires: "dialog", init: function(a) {
                    ...
                    if (CKEDITOR.env.ie && 8 >= CKEDITOR.env.version)
                        ...
                        var a = "dialogs/wsc.js",
                                b = document.location.protocol || "http:";
                        CKEDITOR.scriptLoader.load(CKEDITOR.config.wsc_customLoaderScript || b + "//loader.webspellchecker.net/sproxy_fck/sproxy.php?plugin=fck2&customerid=" + CKEDITOR.config.wsc_customerId + "&cmd=script&doc=wsc&schema=22")
                    } else
                        a = "dialogs/wsc_ie.js";
                    CKEDITOR.dialog.add("checkspell", this.path + a)
                }});
