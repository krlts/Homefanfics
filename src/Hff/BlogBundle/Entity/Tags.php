 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Hff\BlogBundle\Entity\TagsRepository")
 */
class Tags
{
    /**
     ...
     * @var integer
     *
     * @ORM\Column(name="escritos", type="integer")
     */
    private $escritos;
     ...
     * Set escritos
     *
     * @param integer $escritos
     * @return Tags
     */
    public function setEscritos($escritos)
    {
